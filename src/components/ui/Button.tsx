    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-primary text-white hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/20': variant === 'primary',
            'bg-white text-primary border border-border hover:bg-gray-50 hover:border-gray-300': variant === 'secondary',
